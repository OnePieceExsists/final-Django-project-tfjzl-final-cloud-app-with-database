...
from .models import Course, Enrollment, Choice, Submission, Question
...
def submit(request, course_id):
    ...
    # Extract the selected choice IDs from the POST request
    selected_choice_ids = extract_answers(request)
    
    # Add those choices to the submission
    for choice_id in selected_choice_ids:
        submission.choices.add(Choice.objects.get(id=choice_id))

    # Redirect to exam result view
